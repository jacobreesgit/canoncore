      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500 px-2 py-1 bg-gray-100 dark:bg-gray-600 rounded">
              {item.item_type}
            </span>
        ...
        <button
          ...
          className="text-xs text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 px-2 py-1 hover:bg-green-50 dark:hover:bg-green-900/20 rounded transition-colors"
        >
          + Add Child
        </button>
      </div>
